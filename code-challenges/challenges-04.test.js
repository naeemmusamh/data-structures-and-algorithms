...
const containsW = (str) => {
    // Solution code here...
    const matchstring = str.match(/w/g);
    if (matchstring) {
        return true;
    } else {
        return false;
...
// const isNum = (input) => {
//     // Solution code here...
//     const matchNumber = input.match(/\d+/g);
//     if (matchNumber) {
//         return true;
//     } else {
//         return false;
...
const containsWorld = (input) => {
    // Solution code here...
    const matchKeyWord = input.match(/world/g);
    if (matchKeyWord) {
        return true;
    } else {
        return false;
...
const isCapitalized = (str) => {
    //<solution>
    let newArray = [];
    if (str.match(/\b[A-Z]\w*\b/mg) === null) {
        return newArray;
    } else {
        return str.match(/\b[A-Z]\w*\b/mg);
    }
};
