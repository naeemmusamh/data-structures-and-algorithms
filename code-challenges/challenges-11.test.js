...
const toLastNames = people => {
    // Solution code here...
    const peopleArray = people.map(element => {
...
const validatePin = (pin) => {
    // Solution code here...
    const numDigit = /^[0-9]{4}$/;
    return numDigit.test(pin);
};
...
const validateWord = (word) => {
    // Solution code here...
    const wordBetween = /^[A-Z a-z]{5,10}$/;
    return wordBetween.test(word);
};
...
const hasNumber = (string) => {
    // Solution code here...
    const checkDigit = /[A-Z a-z]\d/;
    return checkDigit.test(string);
};
...
const validatePhoneNumber = (phoneNumber) => {
    // Solution code here...
    const checkNumber = /^[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im;
