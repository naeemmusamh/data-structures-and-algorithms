...
const longestString = (arr) => {
    ...
    for (let element of arr) {
        if (element.length > arr[number].length) {
            number = arr.indexOf(element);
        }
    }
    return number;
};
...
const firstLetters = (arr) => {
    // Solution code here...
    const firstLatter = arr.map(element => {
...
const findHappiness = (arr) => {
    // Solution code here...
    const containArray = arr.filter(element => {
...
const standardizePhoneNumbers = (arr) => {
    ...
    const formatNumber = arr.map(element => {
