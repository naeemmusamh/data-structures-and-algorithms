...
describe('test if the function work correctly', () => {
    it('test if it will find the most repeated word', () => {
        let string = 'Once upon a time, there was a brave princess who...';
        expect(findRepeatedWord(string)).toEqual('a');
    });
    ...
    it('test if it will find the most repeated word', () => {
        ...
        expect(findRepeatedWord(string)).toEqual('the');
    });
    ...
    it('test if it will find the most repeated word', () => {
        ...
        expect(findRepeatedWord(string)).toEqual('I');
    });
});